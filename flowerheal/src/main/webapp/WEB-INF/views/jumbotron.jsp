...
<section class="row" id="recommendBanner ">
	<div class="row col-md-10 col-lg-9 col-xl-8 my-2">
		<a href="#"><img class="col p-0 m-0" src="${pageContext.request.contextPath }/resources/img/recommendBanner.png" alt="추천배너" /></a>
	</div>
</section>
