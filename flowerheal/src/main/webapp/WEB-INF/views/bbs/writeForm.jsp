...
<section class="container">
	<form:form modelAttribute="bbsDTO"
						 action="${pageContext.request.contextPath}/bbs/write">
	<form:input path="bid" type="hidden" value="${sessionScope.user.id}"/>
		<div class="row justify-content-center">
			<p class="h3">게시글 작성</p>
		</div>
		<div class="row">
	    <form:label path="btitle" class="col-sm-3">제목</form:label>
	    <form:input path="btitle" class="form-control col-sm-8" type="text"></form:input>
	    ...
	    <form:textarea path="bcontent" class="form-control col-sm-8" style="height:200px"></form:textarea>
